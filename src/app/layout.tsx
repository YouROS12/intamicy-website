...
export const metadata: Metadata = {
  ...
  description: 'Premier store bien-être intime au Maroc — préservatifs, lubrifiants, soins intimes, compléments vitalité. Livraison discrète 24-48h partout au Maroc. Paiement à la livraison.',
  openGraph: {
    type: 'website',
    locale: 'fr_MA',
